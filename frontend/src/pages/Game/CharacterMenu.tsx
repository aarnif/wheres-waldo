      ...
      {characters.map((gameCharacter) => (
        <li key={gameCharacter.id}>
          <button
            ...
            className="flex w-full cursor-pointer items-center justify-between gap-5 rounded-lg px-4 py-1.5 transition-colors duration-200 hover:bg-slate-500/50 disabled:cursor-not-allowed disabled:hover:bg-transparent"
          >
