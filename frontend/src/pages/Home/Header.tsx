...
const Header = () => (
  <header className="font-body flex items-center justify-between p-4">
    ...
    <nav className="flex gap-4 text-white sm:gap-8">
      <Link
        to="/signup"
      ...
      <button className="cursor-pointer rounded-lg bg-slate-500 px-2.25 py-1.5 text-sm font-bold shadow-[3px_3px_0px_0px] shadow-slate-950 transition-all duration-300 hover:bg-slate-600 active:translate-x-0.75 active:translate-y-0.75 active:shadow-none sm:px-3 sm:py-2 sm:text-base">
        Log In
      </button>
    </nav>
  </header>
